...
//        this.game.stage.backgroundColor = 0xFFFFFF; // by michael
        this.game.stage.backgroundColor = 0xffffff; //0x151c23; // by michael
        ...
        iPhone5 = iPhone && pixelRatio>=2 && window.screen.height >= 568 && !iPad; // by michael
        iPhone4 = !iPhone5 && iPhone;
        if (iPhone5)
        {
            gr.drawRect(0,0,scaleValue(420),scaleValue(146+50)); // by michael, 480,530
        }
        else
        {
            gr.drawRect(0,0,scaleValue(420),scaleValue(146)); // by michael, 480,530
        }
        gr.endFill();
        gr.boundsPadding = 0;
