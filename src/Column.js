...
//    var obstacle_2 = group.create( x, scaleValue(480 - height_2+10), gr.generateTexture() );
    var obstacle_2 = group.create( x, scaleValue(518 - height_2+10), gr.generateTexture() ); // by michael
	gr.destroy();
...
//    var ground = group.create( x, scaleValue(480 - height_2), gr.generateTexture() );
	var ground = group.create( x, scaleValue(518 - height_2), gr.generateTexture() ); // by michael
	gr.destroy();
